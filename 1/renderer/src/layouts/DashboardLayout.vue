<template>
  <div class="dash-shell">
    ...
    <nav class="side-nav">
      <RouterLink to="/dashboard/chat" class="brand-mark" aria-label="控制台">
...
const navItems = [
  ...
  { key: "agents", label: "智能体", to: "/dashboard/settings/agents", iconPath: iconPaths.store },
